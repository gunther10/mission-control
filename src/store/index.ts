...
export interface SpawnRequest {
  ...
  status: 'pending' | 'queued' | 'running' | 'waiting_for_approval' | 'waiting_for_input' | 'blocked' | 'timed_out' | 'completed' | 'failed'
  createdAt: number
  updatedAt?: number
  completedAt?: number
  result?: string
...
export interface ConnectionStatus {
  ...
  state?: 'connected' | 'connecting' | 'reconnecting' | 'blocked' | 'disconnected'
  reason?: string
  help?: string
  actionRequired?: string
  lastError?: string
